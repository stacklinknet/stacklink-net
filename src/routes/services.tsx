...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Networking, IT security, wireless, CCTV, IP telephony, infrastructure, structured cabling and SLA-backed 24/7 support across the UAE." },
      { property: "og:image", content: banner },
      { property: "og:url", content: "https://stacklink-elite-theme.lovable.app/services" },
      { property: "og:type", content: "website" },
    ],
    links: [
      { rel: "canonical", href: "https://stacklink-elite-theme.lovable.app/services" },
    ],
  }),
  component: Services,
});

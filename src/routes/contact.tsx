    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: { "@type": "PostalAddress", streetAddress: "Office No 8 & 9, Al Rais Building, Al Souq Al Kabeer, Bur Dubai, United Arab Emirates", addressLocality: "Dubai", addressCountry: "AE" },
          openingHours: "Mo-Sa 09:00-18:00",
          areaServed: ["AE", "UK", "IN"],
          department: [
            { "@type": "LocalBusiness", name: "Stacklink Abu Dhabi", address: { "@type": "PostalAddress", streetAddress: "8 ELECTRA STREET – near ROYAL ROSE HOTEL – AL DHANA – ZONE 1 – Abu Dhabi, United Arab Emirates (UAE)", addressLocality: "Abu Dhabi", addressCountry: "AE" } },
            { "@type": "LocalBusiness", name: "Stacklink Deira", address: { "@type": "PostalAddress", streetAddress: "2 AL DAGHAYA – STREET – DEIRA – Al Sabkha – Dubai, United Arab Emirates (UAE)", addressLocality: "Dubai", addressCountry: "AE" } },
            { "@type": "LocalBusiness", name: "Stacklink UK", address: { "@type": "PostalAddress", streetAddress: "268 Bath Road, Slough, Berkshire, SL1 4DX United Kingdom", addressLocality: "London", addressCountry: "UK" } },
            { "@type": "LocalBusiness", name: "Stacklink Mumbai", address: { "@type": "PostalAddress", streetAddress: "C 201, Kailas Business Park, Veer Savarkar Marg, Parksite Vikhroli (West),Mumbai-400079", addressLocality: "Mumbai", addressCountry: "IN" } },
          ],
        }),
      },
    ],

...
export const Route = createFileRoute("/products")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Browse enterprise IT hardware from 25+ leading brands — firewalls, switches, access points, IP phones, CCTV, servers and storage with UAE-wide delivery." },
      { property: "og:image", content: banner },
      { property: "og:url", content: "https://stacklink-elite-theme.lovable.app/products" },
      { property: "og:type", content: "website" },
    ],
    links: [
      { rel: "canonical", href: "https://stacklink-elite-theme.lovable.app/products" },
    ],
  }),
  component: Products,
});
